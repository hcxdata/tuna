<template>
  <div class="animated fadeIn">
      ...
      <b-col sm="12" md="12" lg="12" xl="12">
        <b-card >
          ...
          <b-table :items="tableItems" :fields="tableFields" hover stacked="md" responsive="sm" >
            <template slot="initalCreateDate" scope="item">
              {{ item.item.initalCreateDate | parseTime('{y}-{m}-{d}') }}
            </template>
    ...
    <b-modal v-model="editModal" :no-close-on-backdrop="true" title="修改客户信息" hide-footer size="lg" centered>
      <b-row>
        <b-col sm="12" md="12" lg="12" xl="12">
    ...
    <b-modal v-model="addModal" :no-close-on-backdrop="true" title="新增客户信息" hide-footer size="lg" centered>
      <b-row>
        <b-col sm="12" md="12" lg="12" xl="12">
...
import { query, create, update, del } from '@/api/customerInfo'
