<template>
  <div class="animated fadeIn">
    ...
    <b-modal v-model="editModal" :no-close-on-backdrop="true" title="修改销售区域" hide-footer size="lg" centered>
      <b-row>
        <b-col sm="12" md="12" lg="12" xl="12">
    ...
    <b-modal v-model="addModal" :no-close-on-backdrop="true" title="新增销售区域" hide-footer size="lg" centered>
      <b-row>
        <b-col sm="12" md="12" lg="12" xl="12">
...
import { query, create, update, del } from '@/api/salesAreaDict'
